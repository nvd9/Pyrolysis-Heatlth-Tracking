...
The **LSTM_A_normaldata** file is used for **clear-standard-most healthy** dataset. It includes some EDA techniques: 
...
You can modify the architecture and parameter for utilizing and having best performance out of it. 
